...
(function () {
    ...
    CollaboratorApi.prototype.loadBoard = function (onOk, onErr) {
        var self = this;
        this.http.request({
            method: "GET",
    ...
    CollaboratorApi.prototype.saveHours = function (progetto, wp, task, mese, ore, onOk, onErr) {
        var self = this;
        var pairs = [
            ["progetto", progetto],
            ["wp", wp],
     ...
     */
    function ProjectTable(api, project, onError) {
        this.api = api;
    ...
    ProjectTable.prototype.element = function () {
        return this.tableEl;
    };

    /* Costruisce la tabella a partire dai dati del progetto. */
    ProjectTable.prototype.build = function () {
    ...
    ProjectTable.prototype.handleEvent = function (event) {
        if (event.type === "click") {
    ...
    ProjectTable.prototype.startEdit = function (td) {
    ...
    ProjectTable.prototype.cancelEdit = function () {
        if (!this.editing) {
            return;
        }
    ...
    ProjectTable.prototype.commitEdit = function () {
        if (!this.editing) {
            return;
        }
    ...
    CollaboratorApp.prototype.showError = function (message) {
        this.errorEl.textContent = message || "";
    };

    /*
     * Mostra la foto del tecnico solo se l'immagine viene caricata con successo:
     * l'<img> parte nascosto, compare al "load" e resta nascosto in caso di "error"
     * (es. file mancante nella cartella locale). Il JSON portava solo l'URL.
     */
    CollaboratorApp.prototype.showPhoto = function (url) {
    ...
    CollaboratorApp.prototype.load = function () {
        var self = this;
    ...
    CollaboratorApp.prototype.onBoard = function (board) {
        this.board = board;
        this.greetingEl.textContent = "Benvenuto, " + board.collaboratorName;
        this.showPhoto(board.photoUrl);
        this.showError("");
    ...
    CollaboratorApp.prototype.handleEvent = function (event) {
        event.preventDefault();
    ...
    CollaboratorApp.prototype.selectProject = function (project, link) {
